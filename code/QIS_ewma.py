...
def QIS_ewma_ridge_torch(X, alpha, ridge, assume_centered=False, verbose=False):
    n, p = X.shape
...
def QIS_ewma_prec_ridge_torch(X, alpha, ridge, assume_centered=False, verbose=False):
    n, p = X.shape
